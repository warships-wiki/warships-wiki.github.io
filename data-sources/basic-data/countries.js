const data = [{
    ...
    id: "ar", title: {es: "Argentina", en: "Argentina", pt: "Argentina", ru: "Аргентина"}, warships: {
        es: "Buques Argentinos", en: "Argentinian Warships", pt: "Navios Argentinos", ru: "Аргентинские военные корабли"
    }, colors: {
    ...
    id: "dm", title: {
        es: "República Dominicana", en: "Dominican Republic", pt: "República Dominicana", ru: "Доминиканская Республика"
    }, warships: {
    ...
    id: "gt", title: {es: "Guatemala", en: "Guatemala", pt: "Guatemala", ru: "Гватемала"}, warships: {
        es: "Buques de Guatemala", en: "Guatemalan Warships", pt: "Navios da Guatemala", ru: "Военные корабли Гватемалы"
    }, colors: {
    ...
    id: "ni", title: {es: "Nicaragua", en: "Nicaragua", pt: "Nicarágua", ru: "Никарагуа"}, warships: {
        es: "Buques de Nicaragua", en: "Nicaraguan Warships", pt: "Navios da Nicarágua", ru: "Военные корабли Никарагуа"
    }, colors: {
        primary: {r: 206, g: 17, b: 38},
        secondary: {r: 0, g: 56, b: 168},
        tertiary: {r: 255, g: 255, b: 255},
    ...
    id: "py", title: {es: "Paraguay", en: "Paraguay", pt: "Paraguai", ru: "Парагвай"}, warships: {
        es: "Buques de Paraguay", en: "Paraguayan Warships", pt: "Navios do Paraguai", ru: "Военные корабли Парагвая"
    }, colors: {
    ...
    id: "kn", title: {
        es: "San Cristóbal y Nieves", en: "Saint Kitts and Nevis", pt: "São Cristóvão e Nevis", ru: "Сент-Китс и Невис"
    }, warships: {
    ...
    id: "ve", title: {es: "Venezuela", en: "Venezuela", pt: "Venezuela", ru: "Венесуэла"}, warships: {
        es: "Buques de Venezuela", en: "Venezuelan Warships", pt: "Navios da Venezuela", ru: "Военные корабли Венесуэлы"
    }, colors: {
        primary: {r: 0, g: 56, b: 168},

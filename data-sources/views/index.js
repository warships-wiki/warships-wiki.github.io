const data = {
    description: {
        ...
        id: "navigation", title: {
            ...
            id: "index", disabled: true, reference: "", title: {
                es: "Inicio", en: "Home", pt: "Início", ru: "Домой"
            }
        }, {
            id: "armies", disabled: true, reference: "armies.html", title: {
                es: "Armadas", en: "Armies", pt: "Forças Armadas", ru: "Армии"
            }
        }, {
            id: "aircraft", disabled: true, reference: "aircraft.html", title: {
            ...
            id: "armaments", disabled: true, reference: "armaments.html", title: {
                es: "Armamentos", en: "Armaments", pt: "Armamentos", ru: "Вооружение"
            }
        }, {
            id: "technologies", disabled: true, reference: "technologies.html", title: {
                es: "Tecnologías", en: "Technologies", pt: "Tecnologias", ru: "Технологии"
            }
        }, {
            id: "policies", disabled: true, reference: "policies.html", title: {
                es: "Políticas Navales", en: "Naval Policies", pt: "Políticas Navais", ru: "Военная политика"
            }
        }, {
            id: "terms", disabled: true, reference: "terms.html", title: {
                es: "Terminologías", en: "Terminologies", pt: "Terminologias", ru: "Терминологии"
            }
        }, {
            id: "cinema", disabled: true, reference: "cinema.html", title: {
            ...
            id: "gaming", disabled: true, reference: "gaming.html", title: {
                es: "Videojuegos", en: "Gaming", pt: "Videojogos", ru: "Игры"
            }
        }, {
            id: "misc", disabled: true, reference: "misc.html", title: {
                es: "Misceláneos", en: "Miscellaneous", pt: "Diversos", ru: "Разное"
            }
        }, {
            id: "docs", disabled: true, reference: "docs.html", title: {
                es: "Documentación", en: "Documentation", pt: "Documentação", ru: "Документация"
            }
        }, {
            id: "links", disabled: true, reference: "links.html", title: {
            ...
            id: "about", disabled: true, reference: "about.html", title: {
            ...
            id: "faq", disabled: true, reference: "faq.html", title: {
            ...
            id: "our-team", disabled: true, reference: "our-team.html", title: {
                es: "Nuestros integrantes", en: "Our Team", pt: "Nossa Equipe", ru: "Наша команда"
            }
        }, {
            id: "collaborators", disabled: true, reference: "collaborators.html", title: {
                es: "Nuestros colaboradores", en: "Our Collaborators", pt: "Nossos Colaboradores", ru: "Наши соавторы"
            }
        }, {
            id: "partners", disabled: true, reference: "partners.html", title: {
